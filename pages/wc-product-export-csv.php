...
$default_image_url = esc_url(WOOCSVIMPORTEXPORT_PLUGIN_URL . 'assets/images/default60.png'); // URL of the default image

?>
    <div class="wrap">
        <h1><?php esc_html_e('Export Products', 'wc-product-import-export-csv');?></h1>
            ...
            <table id="export-table" class="display">
              <thead>
                    <tr>
                        ...
                        <th scope="col"><?php esc_html_e('Images', 'wc-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('Name', 'wc-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('Type', 'wc-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('SKU', 'wc-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('Regular Price', 'wc-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('Sale Price', 'wc-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('Short Description', 'wc-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('Categories', 'wc-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('Tags', 'wc-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('Stock Status', 'wc-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('Stock Quantity', 'wc-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('Attributes', 'wc-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('View Product', 'wc-product-import-export-csv');?></th>
                    </tr>
                </thead>
                <tbody>
                    <?php
...
$cover_image_id = $product->get_image_id();
    ...
    ?>
                            ...
                            <td><a href="<?php echo esc_url(get_permalink($product->get_id())); ?>" target="_blank"><?php esc_html_e('View', 'wc-product-import-export-csv');?></a></td>
                        </tr>
                        <?php
}
?>
            ...
            <p class="submit">
                <input type="submit" id="export-csv-button" value="<?php esc_attr_e('Export Selected Products as CSV', 'wc-product-import-export-csv');?>" class="button button-primary">
            </p>
        </form>
    </div>
