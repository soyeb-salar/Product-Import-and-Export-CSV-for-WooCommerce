...
?>
    <div class="wrap">
        <h1><?php esc_html_e('Export Products', 'woocsv-product-import-export-csv');?></h1>
            ...
            <table id="export-table" class="display">
              <thead>
                    <tr>
                        ...
                        <th scope="col"><?php esc_html_e('Images', 'woocsv-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('Name', 'woocsv-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('Type', 'woocsv-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('SKU', 'woocsv-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('Regular Price', 'woocsv-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('Sale Price', 'woocsv-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('Short Description', 'woocsv-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('Categories', 'woocsv-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('Tags', 'woocsv-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('Stock Status', 'woocsv-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('Stock Quantity', 'woocsv-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('Attributes', 'woocsv-product-import-export-csv');?></th>
                        <th scope="col"><?php esc_html_e('View Product', 'woocsv-product-import-export-csv');?></th>
                    </tr>
                </thead>
                <tbody>
                    <?php
...
$cover_image_id = $product->get_image_id();
    ...
    ?>
                            ...
                            <td><a href="<?php echo esc_url(get_permalink($product->get_id())); ?>" target="_blank"><?php esc_html_e('View', 'woocsv-product-import-export-csv');?></a></td>
                        </tr>
                        <?php
}
?>
            ...
            <p class="submit">
                <input type="submit" id="export-csv-button" value="<?php esc_attr_e('Export Selected Products as CSV', 'woocsv-product-import-export-csv');?>" class="button button-primary">
            </p>
        </form>
    </div>
